<h1 align="center"> 🚀 Swift Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem Swift
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-swift.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Swift) 
